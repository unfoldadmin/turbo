...
export function TankVisualCard({ tank, onUpdateLevel }: TankVisualCardProps) {
  ...
  const currentLevel = tank.latest_reading ? parseFloat(tank.latest_reading.level) : 0
  const maxLevel = parseFloat(tank.usable_max_inches)
  const minLevel = parseFloat(tank.usable_min_inches)
  ...
  return (
    ...
    >
      <div className="p-4 text-center space-y-4">
        ...
        {/* Level Info */}
        <div>
          <div className="text-3xl font-bold text-gray-800">{currentLevel.toFixed(1)}"</div>
